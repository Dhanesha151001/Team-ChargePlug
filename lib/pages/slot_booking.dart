...
class slotbookingPage extends  StatefulWidget{
  const slotbookingPage({Key? key,required this.title}) : super(key: key);
        ...
        flexibleSpace:Container(
          decoration: BoxDecoration(
              gradient: LinearGradient(
                  ...
                  colors: <Color>[Theme.of(context).primaryColor, Theme.of(context).secondaryHeaderColor,]
              )
          ),
        ),
      ),
      ...
      body: SingleChildScrollView(
        child: Stack(
          children: [
            const SizedBox(
              height: 150,
              child: HeaderWidget(150, false, Icons.access_time),
            ),
            Container(
                            ...
                            onPressed: () {
                              if (_formKey.currentState!.validate()) {
                                Navigator.of(context).pushAndRemoveUntil(
                                    MaterialPageRoute(
                                        builder: (context) =>  const slotbookingPage(title: '',)
                                    ),
